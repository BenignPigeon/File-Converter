...
set "batFilesRoaming=%APPDATA%\Bat-Files\File-Converter"
...
:: Step 1: Delete the File-Converter folder  in Local AppData
...
:: Step 2: Delete the File-Converter folder in Roaming AppData
if exist "%batFilesRoaming%" (
    echo Deleting "%batFilesRoaming%"...
    rmdir /S /Q "%batFilesRoaming%"
    echo File-Converter folder in Roaming AppData deleted.
) else (
    echo File-Converter folder in Roaming AppData not found.
)

:: Step 3: Delete the File Converter shortcut on the Desktop
...
:: Step 4: Delete the File Converter shortcut in the Start Menu
